...
** TODO Fix lists in journal entries
...
** TODO Octicon replacement. There's no need to include all the octicons when this app uses 10-15 of them.
...
** TODO Electron port
** TODO Refactor frontend code to be more organized
