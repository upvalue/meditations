...
var dbseedentries = []struct{Text string}{
	{`<p>Some things are in our control and others not. Things in our control
...
not in our control, be prepared to say that it is nothing to you.</p>`},
	{`<p>Remember that following desire promises the attainment of that
...
and even these lightly, and with gentleness and reservation.</p>`},
	{`<p>With regard to whatever objects give you delight, are useful, or
...
disturbed if either of them dies.</p>`},
	{`<p>When you are going about any action, remind yourself what nature
...
at things that happen.</p>`},
	{`<p>Men are disturbed, not by things, but by the principles and notions
...
himself.</p>`},
	{`<p>Don't be prideful with any excellence that is not your own. If
...
take pride in some good of your own.</p>`},
	{`<p>Consider when, on a voyage, your ship is anchored; if you go on
...
you should be unable to come in time.</p>`},
	{`<p>Don't demand that things happen as you wish, but wish that they
happen as they do happen, and you will go on well.</p>`},
	{`<p>Sickness is a hindrance to the body, but not to your ability to
...
as hindrances to something else, but not to yourself.</p>`},
	{`<p>With every accident, ask yourself what abilities you have for
...
of things will not hurry you away along with them.</p>`},
	{`<p>Never say of anything, "I have lost it"; but, "I have returned
...
just as travelers view a hotel.</p>`},
	{`<p>If you want to improve, reject such reasonings as these: "If I
...
that it should be in his power to give you any disturbance.</p>`},
	{`<p>If you want to improve, be content to be thought foolish and stupid
...
neglect the other.</p>`},
	{`<p>If you wish your children, and your wife, and your friends to
...
on others else he must necessarily be a slave.</p>`},
	{`<p>Remember that you must behave in life as at a dinner party. Is
...
became, and were called, divine.</p>`},
	{`<p>When you see anyone weeping in grief because his son has gone
...
not moan with him. Do not moan inwardly either.</p>`},
	{`<p>Remember that you are an actor in a drama, of such a kind as the
...
choose it is another's.</p>`},
	{`<p>When a raven happens to croak unluckily, don't allow the appearance
...
happens, it is in my control to derive advantage from it."</p>`},
	{`<p>You may be unconquerable, if you enter into no combat in which
...
in our own control.</p>`},
	{`<p>Remember, that not he who gives ill language or a blow insults,
...
you will more easily command yourself.</p>`},
...
any abject thought, nor too eagerly covet anything.</p>`},
	{`<p>If you have an earnest desire of attaining to philosophy, prepare
...
if you are conquered by them, you will incur a double ridicule.</p>`},
	{`<p>If you ever happen to turn your attention to externals, so as
...
yourself, and it will suffice you.</p>`},
	{`<p>Don't allow such considerations as these distress you. "I will
...
become faithless and void of shame.</p>`},
	{`<p>Is anyone preferred before you at an entertainment, or in a compliment,
...
the not bearing with his behavior at coming in.</p>`},
	{`<p>The will of nature may be learned from those things in which we
...
how we are affected in hearing the same thing concerning others.</p>`},
	{`<p>As a mark is not set up for the sake of missing the aim, so neither
does the nature of evil exist in the world.</p>`},
	{`<p>If a person gave your body to any stranger he met on his way,
...
to verbally attack you?</p>`},
	{`<p>In every affair consider what precedes and follows, and then undertake
...
without you; that is, be either a philosopher, or one of the vulgar.</p>`},
	{`<p>Duties are universally measured by relations. Is anyone a father?
...
several relations.</p>`},
	{`<p>Be assured that the essential property of piety towards the gods
...
his ability.</p>`},
	{`<p>When you have recourse to divination, remember that you know not
...
another was murdering him.</p>`},
	{`<p>Immediately prescribe some character and form of conduce to yourself,
...
show yourself to be displeased by such talk.</p>`},
	{`<p>If you are struck by the appearance of any promised pleasure,
...
of having gained so great a victory.</p>`},
	{`<p>When you do anything from a clear judgment that it ought to be
...
censure you wrongly?</p>`},
	{`<p>As the proposition, "Either it is day or it is night," is extremely
...
the person who gives the entertainment.</p>`},
	{`<p>If you have assumed any character above your strength, you have
both made an ill figure in that and quitted one which you might have

supported.</p>`},
	{`<p>When walking, you are careful not to step on a nail or turn your
...
undertake the action with the greater safety.</p>`},
	{`<p>The body is to everyone the measure of the possessions proper
...
which once exceeds a due measure, there is no bound.</p>`},
	{`<p>Women from fourteen years old are flattered with the title of
...
of decent, modest and discreet behavior.</p>`},
	{`<p>It is a mark of want of genius to spend much time in things relating
...
care of the understanding.</p>`},
	{`<p>When any person harms you, or speaks badly of you, remember that
...
you will say upon every occasion, "It seemed so to him."</p>`},
	{`<p>Everything has two handles, the one by which it may be carried,
...
as it is to be carried.</p>`},
	{`<p>These reasonings are unconnected: "I am richer than you, therefore
...
nor style.</p>`},
	{`<p>Does anyone bathe in a mighty little time? Don't say that he does
...
hazard of assenting to any appearances but such as you fully comprehend.</p>`},
	{`<p>Never call yourself a philosopher, nor talk a great deal among
...
the actions produced by them after they have been digested.</p>`},
	{`<p>When you have brought yourself to supply the necessities of your
...
a little cold water in your mouth, and spurt it out and tell nobody.</p>`},
...
a word, he watches himself as an enemy, and one in ambush.</p>`},
	{`<p>When anyone shows himself overly confident in ability to understand
...
consonant to his discourse.</p>`},
	{`<p>Whatever moral rules you have deliberately proposed to yourself.
...
of becoming a Socrates.</p>`},
	{`<p>The first and most necessary topic in philosophy is that of the
...
not right.</p>`},
	{`<p>Upon all occasions we ought to have these maxims ready at hand:
